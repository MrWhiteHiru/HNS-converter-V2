...
def binary():
	...
	def to_decimal():
		...
		print("\n")
		print(pi+"""   """+b+"""<---Answer--->\n"""+reset+pi+reset+""+s_b+"""Binary"""+reset+"""     """+pi+""">>>"""+reset+"""     """+g+""" Decimal"""+reset+"""     \n"""+pi+s_b,num,reset+"""    """+pi+""">>>"""+reset+"""    """+g,ans,pi+reset)
	...
	def to_octal():
		...
		def BinToOct(num):
			...
			return octal
		print("\n")
		print(pi+"""   """+b+"""<---Answer--->\n"""+reset+"""   """+pi+reset+"\n"+s_b+"""Binary"""+reset+"""      """+pi+""">>>"""+reset+"""     """+g+""" Octal"""+reset+"""       \n"""+pi+reset+s_b,num,reset+"""    """+pi+""">>>"""+reset+"""    """+g,BinToOct(num),pi+reset)
	...
	def to_hexadecimal():
		...
		def BinToHex(num):
			...
			return hexa
		print("\n")
		print(pi+"""   """+b+"""<---Answer--->\n"""+reset+pi+reset+"\n"+s_b+"""Binary"""+reset+"""      """+pi+""">>>"""+reset+"""   """+g+""" Hexadecimal"""+reset+"""   \n"""+pi+reset+s_b,num,reset+"""    """+pi+""">>>"""+reset+"""    """+g,BinToHex(num),pi+reset)
	
	print(pi+"""  \n\n"""+s_b+"""From Binary To\n"""+reset+"""  \n"""+pi+reset+s_b+"""[1] """+y+"""->>"""+g+""" Decimal"""+reset+"""\n"""+pi+reset+s_b+"""[2] """+y+"""->>"""+g+""" Octal"""+reset+"""      \n"""+pi+reset+s_b+"""[3] """+y+"""->>"""+g+""" Hexadecimal"""+reset+"""           \n"""+pi+reset)

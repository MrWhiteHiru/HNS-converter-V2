...
def decimal():
	...
	def to_binary(num):
		...
		if point != True:
			...
			out_ans = total_ans
		print("\n")
		print(pi+reset+"""   """+b+"""<---Answer--->"""+reset+"""   """+pi+reset+"     \n"+s_b+"""Decimal"""+reset+"""     """+pi+""">>>"""+reset+"""     """+g+""" Binary"""+reset+"""      \n"""+pi+reset+s_b,num,reset+"""    """+pi+""">>>"""+reset+"""    """+g,out_ans,pi+reset)
	...
	def to_octal(num):
		...
		if point != True:
			...
			out_ans = total_ans
		print("\n")
		print(pi+reset+"""   """+b+"""<---Answer--->"""+reset+"""   \n"""+pi+reset+""+s_b+"""Decimal"""+reset+"""     """+pi+""">>>"""+reset+"""     """+g+""" Octal"""+reset+"""       \n"""+pi+reset+s_b,num,reset+"""     """+pi+""">>>"""+reset+"""    """+g,out_ans,pi+reset)
	...
	def to_hexadecimal(num):
		...
		if point != True:
			...
			out_ans = total_ans
		print("\n")
		print(pi+reset+"""   """+b+"""<---Answer--->"""+reset+"""   \n"""+pi+reset+""+s_b+"""Decimal"""+reset+"""     """+pi+""">>>"""+reset+"""   """+g+"""Hexadecimal"""+reset+"""    \n"""+s_b,num,reset+"""     """+pi+""">>>"""+reset+"""    """+g,out_ans,pi+reset)
	
	print(pi+reset+"""  """+s_b+"""From Decimal To"""+reset+""" """+reset+"   \n"+s_b+"""[1] """+y+"""->>"""+g+""" Binary"""+reset+"""   """+reset+"""  \n"""+s_b+"""[2] """+y+"""->>"""+g+""" Octal"""+reset+"""      """+pi+reset+"          \n"+s_b+"""[3] """+y+"""->>"""+g+""" Hexadecimal"""+reset+"""           """+pi+reset)

	to_choice = int(input(y+"""
   ┌──["""+pi+"""Enter the option"""+y+"""]"""+reset+"""
   """+y+"""└─ᐳ  """+s_b))
	print(reset)
	if to_choice <= 3 and to_choice != 0:
		num = input(y+"""
   ┌──["""+pi+"""Enter the number to convert"""+y+"""]"""+reset+"""
   """+y+"""└─ᐳ  """+s_b)
		print(reset)
		if to_choice == 1:
			to_binary(num)

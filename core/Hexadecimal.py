...
def hexadecimal():
	...
	def to_decimal(num):
		...
		print("\n")
		print(pi+reset+"""   """+b+"""<---Answer--->"""+reset+"""   \n"""+pi+reset+s_b+"""Hexadecimal"""+reset+"""   """+pi+""">>>"""+reset+"""      """+g+"""Decimal"""+reset+"""     \n"""+reset+s_b,num,reset+"""     """+pi+""">>>"""+reset+"""    """+g,ans,pi+reset)
	
	print(+s_b+""" From Hexadecimal To """+pi+reset+"    \n"+s_b+"""[1] """+y+"""->>"""+g+""" Binary"""+reset+"""     \n"""+reset+"    "+s_b+"""[2] """+y+"""->>"""+g+""" Decimal"""+reset+"""    \n"""+pi+reset)
   ...
   """+y+"""└─ᐳ  """+s_b)
		...
		if to_choice == 1:
			...
			print(r+" Wrong Input !, try again"+reset)
	else:
		print(r+" Wrong Input !, try again"+reset)
# hexadecimal()

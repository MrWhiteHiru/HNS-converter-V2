...
def octal():
	...
	def to_binary(num):
		...
		if point != True:
			...
			out_ans = total_ans
		print("\n")
		print("""            """+b+"""Answer\n"""+reset+"""   """+s_b+"""Octal"""+reset+"""      """+pi+""">>>"""+reset+"""      """+g+"""Binary\n"""+reset+"""     """+reset+s_b,num,reset+"""    """+pi+""">>>"""+reset+"""   """+g,out_ans,pi+"""   """+reset)
	...
	def to_decimal(num):
		...
		print("\n")
		print("""          """+b+"""Answer\n"""+reset+"""   """+s_b+"""Octal"""+reset+"""    """+pi+""">>>"""+reset+"""    """+g+"""Decimal"""+reset+"""      \n"""+"   "+s_b,num,reset+"""     """+pi+""">>>"""+reset+"""    """+g,ans,pi+"""
     """+reset)
	
	print(s_b+"""From Octal To\n\n"""+reset+s_b+"""[1] """+y+"""->>"""+g+""" Binary\n"""+reset+s_b+"""[2] """+y+"""->>"""+g+""" Decimal"""+reset+"""    """+pi+"""   """+reset)
